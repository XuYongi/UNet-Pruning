...
from utils.dataset_DA import BasicDataset
from torch.utils.data import DataLoader, random_split
from dice_loss import dice_loss
from focal_loss import FocalLoss
dir_img = '../data/train/dilation/imgs/'
dir_mask = '../data/train/dilation/masks/'  #使用膨胀后的标签
dir_img = '../data/train/dilation/imgs/'
dir_mask = '../data/train/dilation/masks/'  #使用膨胀后的标签
# dir_img = '../data/train/dilation_BG/imgs/'
# dir_mask = '../data/train/dilation_BG/masks/'  #使用膨胀后的标签
...
def train_net(net,
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'min' if net.n_classes > 1 else 'max', factor=0.5, patience=8)
        ...
        if save_cp:
            ...
            if last_loss > epoch_loss or last_val_score < val_score:
                ...
                torch.save(net.state_dict(),
                           dir_checkpoint + 'CP_epoch{}Trainloss{}ValDice{}.pth'.format(epoch + 1,epoch_loss/n_train, val_score))
                logging.info('Checkpoint {} saved !'.format(epoch + 1)+'   CP_epoch{}Trainloss{}ValDice{}.pth'.format(epoch + 1,epoch_loss/n_train, val_score))
...
def get_args():
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='../checkpoints/CP_epoch92Trainloss0.006515162981715854ValDice0.9080783310143844.pth',
